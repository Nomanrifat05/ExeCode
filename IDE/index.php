...
<body>
  ...
  <div class="small-navbar">
    <ul>
      <li><a href="../ProblemSet/problemset.php?contest_id=<?php echo $contest_id; ?>">Problems</a></li>
      <li><a href="../Standing/standing.php?contest_id=<?php echo $contest_id; ?>">Standing</a></li>
    </ul>
  </div>
